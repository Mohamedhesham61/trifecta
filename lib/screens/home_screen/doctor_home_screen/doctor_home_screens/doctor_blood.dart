...
class DoctorBloodDonation extends StatefulWidget {
  const DoctorBloodDonation({Key? key}) : super(key: key);

  @override
  State<DoctorBloodDonation> createState() => _DoctorBloodDonationState();
}

class _DoctorBloodDonationState extends State<DoctorBloodDonation> {
  @override
