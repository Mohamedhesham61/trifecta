    ...
    return SafeArea(
      child: BlocConsumer<TrifectaCubit,TrifectaStates>(
        listener: (context,state){
          if(state is CreateRequestRideSuccessState)
            {
            ...
            body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Spacer(),
                  ConditionalBuilder(
                    condition: state is! CreateRequestRideLoadingState,
                    builder: (BuildContext context) => defaultButton(
                      text: 'Request',
                      onPressed: (){
                        cubit.createRideRequest(location: address, issue: issueController.text,date: formatter);
                      },
                      radius: 100,
